...
class FlickrController extends GetxController with GetTickerProviderStateMixin {
  ...
  final title = 'Flick UTPL'.obs;
  Rx<String> currentFlickrDesc = "".obs;
  ...
  void onChangueFlckr(TvTemplateBody item, int index) {
    currentFlickrDesc.value = item.flickrData[index].title;
  }
}
